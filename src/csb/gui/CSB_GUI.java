...
public class CSB_GUI implements CourseDataView {
    ...
    private void initScheduleItemsControls() {
        ...
        moveUpButton = initChildButton(lectureToolbar, CSB_PropertyType.MOVE_UP_ICON, CSB_PropertyType.MOVE_UP_LECTURE_TOOLTIP, false);
        moveDownButton = initChildButton(lectureToolbar, CSB_PropertyType.MOVE_DOWN_ICON, CSB_PropertyType.MOVE_DOWN_LECTURE_TOOLTIP, false);
